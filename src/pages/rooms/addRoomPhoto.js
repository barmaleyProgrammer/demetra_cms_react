...
import { createRoomPhoto } from "../../api";


const AddRoomPhoto = ({close}) => {
    ...
    const addRoomPhoto = (event) => {
        event.preventDefault();
        createRoomPhoto(form).then(() => {
            close();
        })
    };
    ...
    return (
        <div className="p-8 bg-amber-200">
            ...
            <form className="mt-6 space-y-6 from" action="#" autoComplete="off" onSubmit={addRoomPhoto}>
